...
module.exports = {
  ...
  // v10.16 NEW — A/B test candidate, OFF by default (live behavior
  // unchanged unless explicitly turned on). The "70%-mid" Fib candidate
  // (neither the 61.8% nor 78.6% named ratio — see strategy.js/backtest.js
  // for where this is selected) has underperformed across three separate
  // independent 360-day backtests: 58.3% WR (12 trades) vs 82.4%/83.3%
  // for the two named ratios (34/12 trades) in the most recent run.
