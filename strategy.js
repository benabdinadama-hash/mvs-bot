 ...
 *  │  ENTRY → Entry engine (15min by default — set by config.TIMEFRAME) (confluence + rejection + absorption + SL/TP)  │
 *  └─────────────────────────────────────────────────────────────────────┘
 *
...
⚡ *MVS v8.1 — Structure is everything.*
    `.trim();
...
console.log('');
console.log('╔══════════════════════════════════════════════════════════════╗');
console.log('║   MVS — Monthly Value Sniper v8.1   by Abdin               ║');
