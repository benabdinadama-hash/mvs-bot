/**
 * ═══════════════════════════════════════════════════════════════════════
 *  MVS — Monthly Value Sniper v10.15.9
...
module.exports = {
  ...
  // v10.16 VARIANT (A/B test — see execution-research/ for how to run):
  // STRUCT_TIMEFRAME changed 1H -> 2H, ISOLATED single-variable change.
  // Hypothesis, from GWP's own documented evidence: shorter structure
  // timeframes produce shallower, more whipsawed zones that invalidate
  // too often; a longer structure candle holds/respects zones better.
  // Everything else below is IDENTICAL to the live config.js baseline —
  // if this variant's backtest differs from baseline, this is the only
  // reason why.
  DAILY_TIMEFRAME:   '1day',
  BIAS_TIMEFRAME:    '4hour',
  STRUCT_TIMEFRAME:  '2hour',   // <-- the one change
  ...
  STRUCT_BAR_SECONDS:  7200,   // <-- matches STRUCT_TIMEFRAME 2hour above
